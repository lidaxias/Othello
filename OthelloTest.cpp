...
// TicTacToeTest.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(OthelloTestApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()

// Создание OthelloTestApp

OthelloTestApp::OthelloTestApp()
{
...
// Единственный объект OthelloTestApp

OthelloTestApp theApp;


// Инициализация OthelloTestApp

BOOL OthelloTestApp::InitInstance()
{
